...
# Direct tool callable mappings
TOOL_FUNCTIONS = {
    "workbook_info": workbook.workbook_info,
    "workbook_schema_cards": workbook.workbook_schema_cards,
    "sheet_list": sheets.sheet_list,
    ...
    "range_write_formulas": ranges.range_write_formulas,
    "range_clear": ranges.range_clear,
    "range_fill_down": ranges.range_fill_down,
    "formula_explain": formulas.formula_explain,
    "formula_evaluate": formulas.formula_evaluate,
    "formula_audit_sheet": formulas.formula_audit_sheet,
    "table_create": tables.table_create,
    "table_list": tables.table_list,
    "table_add_column": tables.table_add_column,
    "pivot_create": pivots.pivot_create,
    "pivot_list": pivots.pivot_list,
    "pivot_add_row_field": pivots.pivot_add_row_field,
    "pivot_add_value": pivots.pivot_add_value,
    "pivot_refresh": pivots.pivot_refresh,
    "chart_create": charts.chart_create,
    "chart_list": charts.chart_list,
    "slicer_add": charts.slicer_add,
    "format_range": formatting.format_range,
    "number_format": formatting.number_format,
    "conditional_format_add": formatting.conditional_format_add,
    "conditional_format_clear": formatting.conditional_format_clear,
    "autofit": formatting.autofit,
    "freeze_panes": formatting.freeze_panes,
    "data_validation_add": validation.data_validation_add,
    "duplicates_find": validation.duplicates_find,
    "trim_clean_range": validation.trim_clean_range,
    "name_define": names.name_define,
    "name_list": names.name_list,
    "comment_add": names.comment_add,
    "sheet_sql": analysis.sheet_sql,
    "sheet_profile": analysis.sheet_profile,
    "script_run_typescript": scripts.script_run_typescript,
    "vba_run": scripts.vba_run,
    "view_select": view.view_select,
    "view_highlight": view.view_highlight,
    "view_screenshot": view.view_screenshot,
    "snapshot_restore": snapshots.snapshot_restore,
    "snapshot_info": snapshots.snapshot_info,
}
